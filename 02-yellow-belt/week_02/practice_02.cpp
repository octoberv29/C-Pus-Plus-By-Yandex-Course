...
void TestGetDistinctRealRootCount() {
  {
    // AssertEqual(GetDistinctRealRootCount(2, 5, 2), 2, "1: positive D");
    // AssertEqual(GetDistinctRealRootCount(2, 4, 2), 1, "2: zero D");
    // AssertEqual(GetDistinctRealRootCount(2, 1, 2), 0, "3: negative D");
    // AssertEqual(GetDistinctRealRootCount(0, 4, 10), 1, "4:");
    // AssertEqual(GetDistinctRealRootCount(0, 0, 1), 0, "5: no root");
  }
}
...
int GetDistinctRealRootCount(double a, double b, double c) {
  ...
  // double d = b*b - 4*a*c;
  // if (d < 0) return 0;
  // int result_01 = (-b + sqrt(d))/(2*a);
  // int result_02 = (-b - sqrt(d))/(2*a);
  // return result;
}
